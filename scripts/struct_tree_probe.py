"""Probe a PDF's structure tree (StructTreeRoot) to inform benchmark predictions.

Returns aggregated facts about a tagged PDF: tag types and counts, presence of
proper headings, table headers (TH), figure alt text, link annotations, etc.
This is independent of our parser — it reads the raw struct tree directly via
PyMuPDF xref operations.
"""
